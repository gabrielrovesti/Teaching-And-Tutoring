...
private:
    ...
    bool pubblico;
public:
    File(double dim, bool pub): 
    dimensione(dim), pubblico(pub){}
    ...
    virtual double calcolo() = 0;
    virtual int calcolo2() = 0;
};
...
private:
    bool lossy;
public:
    Photo(double dim, bool pub, bool los): 
    File(dim, pub), lossy(los){}
