...
int main() {
    ...
    //(dynamic_cast<B*>(q1))->m();
    //(static_cast<C*>(q2))->g();
    (static_cast<C*>(q3->n()))->f(); //  B::n  B::f (tipo dinamico)
    
    // dynamic_cast = dà sempre errore
...
int main() {
    ...
    (static_cast<C*>(q3->n()))->f(); //  A::n  A::f (tipo dinamico)
    /// dynamic_cast = dà sempre errore
...
public:
    ...
    /// oppure virtual void f() const {cout <<" A::f ";}
    virtual void g() {cout <<" A::g "; m(); }
    virtual void h() {cout <<" A::h "; f();}
    void m() {cout <<" A::m "; f();}
    virtual A* n() {cout <<" A::n "; return this;}
...
public:
    ...
    /// oppure - virtual void f() const {cout <<" B::f ";}
    void g() {cout <<" B::g "; A::n();}
    virtual void m() {cout <<" B::m "; f();}
    A* n() {cout <<" B::n "; return this;}
};
...
int main() {
    ...
    (static_cast<C*>(q3->n()))->f(); //  A::n  C::f (tipo dinamico)
    /// dynamic_cast = dà sempre errore
