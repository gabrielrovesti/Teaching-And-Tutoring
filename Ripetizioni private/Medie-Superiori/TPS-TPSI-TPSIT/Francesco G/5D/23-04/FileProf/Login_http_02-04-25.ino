#include <WiFi.h>
#include <WebServer.h>
#include "pagine.h" // File che contiene le pagine in formato testo

const char *ssid = "tessarolo";
const char *password = "PArbEKar12";

// Oggetto di tipo server
WebServer server(80);
...
void login(){
  ...
  bool username=false;
  bool password=false;
  // uint8_t = byte = Insieme di byte (ciclo for) che arrivano al server come richiesta HTTP
